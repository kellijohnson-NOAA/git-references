[//]: # (Markdown comments)
[//]: # (wrap a reference in [] and a subsequent link with ())
...
often analyzed using size-at-age data (@vonbertalanffy_1938).
